...
export type NewSubscriptionMutation = { __typename?: 'Mutation', createSubscriber?: { __typename?: 'Subscriber', id: string } | null };
...
export const NewSubscriptionDocument = gql`
  ...
  createSubscriber(data: {name: $name, email: $email}) {
    ...
    `;
export type NewSubscriptionMutationFn = Apollo.MutationFunction<NewSubscriptionMutation, NewSubscriptionMutationVariables>;
 ...
 * });
 */
export function useNewSubscriptionMutation(baseOptions?: Apollo.MutationHookOptions<NewSubscriptionMutation, NewSubscriptionMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<NewSubscriptionMutation, NewSubscriptionMutationVariables>(NewSubscriptionDocument, options);
      }
export type NewSubscriptionMutationHookResult = ReturnType<typeof useNewSubscriptionMutation>;
export type NewSubscriptionMutationResult = Apollo.MutationResult<NewSubscriptionMutation>;
export type NewSubscriptionMutationOptions = Apollo.BaseMutationOptions<NewSubscriptionMutation, NewSubscriptionMutationVariables>;
